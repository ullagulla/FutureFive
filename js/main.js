...
$(document).ready(function(){
    ...
    setInterval( () => {
        $('#logo-bg').attr('src', './src/LOGO_BLINK.png')
        setTimeout( () => {
            $('#logo-bg').attr('src', './src/LOGO_BG.png')
        }, 150);
    }, 10000);
...
function showCard(e) {
    ...
    setTimeout( () => {
        ...
        r = Math.floor(r)
        $(e.target).attr('src', './src/card'+ r + '.png')
...
function hideCard(e) {
    ...
    setTimeout( () => {
        ...
        $(e.target).attr('src', './src/cardback.png')
